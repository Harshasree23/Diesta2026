...
const Footer = () => {
    return(
        ...
        <footer className='flex flex-col items-center justify-center sm:flex-row md:justify-between justify-center flex-wrap' >
            ...
            <div className='text-[#FFD700] w-[30%] text-2xl mb-5 flex flex-wrap justify-center items-end gap-5 sm:p-10 sm:border-r-2' > 
                <div> <img src={DiestaLogo} alt="Diesta logo" className='h-20' /> </div>
                <div className='sm:text-3xl' > Diesta 2026 </div>
            </div>
            ...
            <div className='flex-1 flex flex-wrap justify-around items-center'>
                ...
                <div className='flex flex-wrap items-end gap-3 text-md' >
                    <div><img src={Instalogo} alt="Instagram logo" className='h-10 w-10' /></div>
                    <div>Insta handle</div>
                </div>
            </div>
        </footer>
